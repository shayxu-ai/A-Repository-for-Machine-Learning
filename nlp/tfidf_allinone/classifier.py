...
"""
import numpy as np
from sklearn.model_selection import train_test_split    # cross_validation 改为 model_selection
...
def get_data():
    ...
    with open("data/ham_data.txt", encoding="utf8") as ham_f, open("data/spam_data.txt", encoding="utf8") as spam_f:
        ...
        ham_label = [1] * len(ham_data)
        spam_label = [0] * len(spam_data)
...
def remove_empty_docs(corpus, labels):
    # 去除空文本。这个去除方式蛮有劲的。要我的话就enumerate了
    filtered_corpus = []
    filtered_labels = []
